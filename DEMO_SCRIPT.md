...
`SESSION_REPORT.md` (Session 4) — i.e., after you've actually seen a
purchase succeed once already. Don't debug live on camera.
...
## 4. Show the limit actually blocking it (20s)
