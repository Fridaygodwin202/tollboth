...
4. Under **Environment Variables**, set:
   - `NEXT_PUBLIC_API_URL` — the Railway URL from step 2.4, e.g. `https://tollbooth-api.up.railway.app`.
...
- Railway's free/trial tier may sleep or expire — check before recording
  the demo that the service is actually warm, not cold-starting on first
  click.
